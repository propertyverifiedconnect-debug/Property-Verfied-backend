...
const { signup, login, logOut, handleRequestResetRoute, handleUpdatePasswordRoute, googleAuth, resetContact, signupPartner, resetContactPartner } = require('../controllers/authController');
